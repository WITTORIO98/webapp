...
@Component({
  selector: 'app-engineer1',
  templateUrl: './engineer1.component.html',
  styleUrls: ['./engineer1.component.scss']
})
export class Engineer1Component implements OnInit, OnDestroy {
